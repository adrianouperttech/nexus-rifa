...
exports.PlanosAssinaturaController = void 0;
const common_1 = require("@nestjs/common");
const planos_assinatura_service_1 = require("./planos-assinatura.service");
const create_plano_assinatura_dto_1 = require("./dto/create-plano-assinatura.dto");
let PlanosAssinaturaController = class PlanosAssinaturaController {
    constructor(planosAssinaturaService) {
        this.planosAssinaturaService = planosAssinaturaService;
    }
    create(createPlanoAssinaturaDto) {
