...
export declare class ReservasService {
    ...
    constructor(logger: LoggerService, reservaRepository: Repository<Reserva>, connection: Connection, rifasService: RifasService, emailService: EmailService, whatsappService: WhatsappService);
    ...
    findByStatus(tenant_id: string, status: string): Promise<Reserva[]>;
